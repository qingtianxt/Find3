	...
	<body>
		...
		<div class="container">
			...
			<%
				...
				lfi=(losefindinfo)session.getAttribute("lfi");
			%>
			<div class="row">
			...
			<div class="panel panel-danger">
				  <div class="panel-heading ">
				    <h2 class="panel-title"><a href="">标题：<%=lfi.getShorttitle() %></a></h2>
				  </div>
				  <div class="panel-body">
				  	<font size="4">发起人：<%=lfi.getUser() %></font>
				  	<h4><small>发起时间：2017-05-15 13:50:24</small></h4>
				    <div class="row">
					   <div class="col-md-3">
					   		<img src="img/key.jpg" width="200px" alt=""></img>
					   </div>
					   <div class="col-md-9">
					   	<p>类别：<%=lfi.getCategory() %></p>
					   	<p>丢失时间：2017-05-12</p>
					   	<p>丢失地点：<%=lfi.getPlace() %></p>
					   	<p>详细信息：<%=lfi.getInformation() %></p>
					   	<p></p>
					   </div>
					</div>
				  </div>
